  ...
  <header class="relative overflow-hidden py-6 px-4 sm:px-6 lg:px-8 bg-gray-900/80 border-b border-gray-700/50">
    <div class="relative max-w-7xl mx-auto text-center flex justify-between items-center">
      ...
      <div class="flex gap-6 justify-center">
        ...
        <a
          href="#"
          class="w-10 h-10 bg-gray-800/50 hover:bg-[#7acfb5] rounded-full flex items-center justify-center transition-all duration-200 transform hover:scale-110 backdrop-blur-sm hover:shadow-[0_0_4px_#7acfb5]">
          <svg class="w-6 h-6 text-slate-200" fill="currentColor" viewBox="0 0 24 24">
            <path
